 ...
 function getSizeCost() {
  ...
  $(document).ready(function () {
    $("#delivery").submit(function () {
        ...
        prompt("Hello " + name + ". Your order has been successfuly received and will be delivered to " +  location + " within one hour.The delivery will cost ksh 180/= Thank you for chosing the pizzeria.");
